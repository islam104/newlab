            ...
            switch (ch) {
                ...
                default -> {
                    if (ch <= 0x1F) {
                        ...
                        out.append("0".repeat(4 - hex.length())); //наличие «одиноких суррогатов» (lone surrogates) должно приводить к ошибке сериализация чисел должна соответствовать правилам ECMAScript для IEEE‑754 double; NaN и Infinity недопустимы и должны приводить к ошибке.
                        out.append(hex);
                    } else {
                        out.append(ch);
                    }
