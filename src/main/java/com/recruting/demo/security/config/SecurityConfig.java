    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/malware-signatures", "/api/malware-signatures/upload", "/api/malware-signatures/by-ids", "/api/malware-signatures/files/presigned-urls")
                        .hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/malware-signatures/**")
                        .hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/malware-signatures/**")
                        .hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/malware-signatures", "/api/malware-signatures/increment", "/api/malware-signatures/*/history", "/api/malware-signatures/*/audit")
                        .hasAnyRole("ADMIN")
